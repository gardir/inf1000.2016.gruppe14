...
public class StudentSystem {
	...
	private static void skrivUtStudent() {
		...
		Student studenten = hentStudent( studentnavn );
		if ( studenten != null ) {
			System.out.println( studenten.hentAlleFag() );
		} else {
	...
	private static void skrivUtFag() {
		...
		if ( alleFag.containsKey( fagnavn ) ) {
			System.out.println( alleFag.get(fagnavn).hentInfo() );
		} else {
	...
	private static void skrivUtAlt() {
		for (Fag fag : alleFag.values()) {
			System.out.println( fag.hentInfo() );
		}
		for ( Student s : alleStudenter ) {
			System.out.println( s.hentAlleFag() );
		}
	}
...
//					System.out.println("Student: " + linje);
	...
	private static void testStudent() {
		...
		System.out.println( student.hentAlleFag() );
	...
	private static void skrivTilFil() throws Exception {
		String filnavn = "utfil.txt";
		PrintWriter utfil = new PrintWriter( new File( filnavn ) );
		for ( Fag f : alleFag.values() ) {
//			utfil.println( f.hentInfo() );
			System.out.println( f.hentInfo() );
		}
		utfil.close();
	}
